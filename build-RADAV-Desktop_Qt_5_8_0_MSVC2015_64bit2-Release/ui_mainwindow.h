...
"}*/"));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 1275, 740));
...
"}"));
        ...
        alt_cur_LCD->setSmallDecimalPoint(true);
        ...
        formLayout_7->setWidget(2, QFormLayout::LabelRole, label_24);

        gps_distance = new QLabel(scrollAreaWidgetContents_2);
        gps_distance->setObjectName(QStringLiteral("gps_distance"));

        formLayout_7->setWidget(2, QFormLayout::FieldRole, gps_distance);
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 381, 930));
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 538, 184));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_24->setText(QApplication::translate("MainWindow", "Distance:", Q_NULLPTR));
        gps_distance->setText(QApplication::translate("MainWindow", "----", Q_NULLPTR));
